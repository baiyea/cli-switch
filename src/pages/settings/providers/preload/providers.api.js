  ...
  return {
    settings: {
      ...
      testProvider: (payload) =>
        ipcRenderer.invoke(PROVIDERS_CHANNELS.SETTINGS_PROVIDER_TEST, payload),
      startProviderOAuthLogin: (payload) =>
        ipcRenderer.invoke(PROVIDERS_CHANNELS.SETTINGS_PROVIDER_OAUTH_LOGIN, payload),
      probeProviderOAuth: (payload) =>
        ipcRenderer.invoke(PROVIDERS_CHANNELS.SETTINGS_PROVIDER_OAUTH_PROBE, payload),
      getProviderOAuthLinks: (payload) =>
        ipcRenderer.invoke(PROVIDERS_CHANNELS.SETTINGS_PROVIDER_OAUTH_LINKS, payload),
      testProviderProxy: (payload) =>
        ipcRenderer.invoke(PROVIDERS_CHANNELS.SETTINGS_PROVIDER_PROXY_TEST, payload),
