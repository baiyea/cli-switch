...
function createFileTreeApi() {
  const files = {
    ...
    saveAttachmentImage: (payload) => ipcRenderer.invoke(FILE_TREE_CHANNELS.ATTACHMENT_SAVE, payload),
    saveAttachmentImageBuffer: (payload) => ipcRenderer.invoke(FILE_TREE_CHANNELS.ATTACHMENT_SAVE_BUFFER, payload),
